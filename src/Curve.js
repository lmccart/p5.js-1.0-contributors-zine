    ...
    return (
      <div className={`${this.props.className ? this.props.className : "indexCurveHolder"}`}>
        ...
        <span className="aboutCurve firstCurve">
          <svg focusable="false" aria-hidden="true" role="img" preserveAspectRatio="none" version="1.1" className="curve" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 25 17.94">
